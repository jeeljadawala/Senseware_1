...
Positioned(bottom: MediaQuery.of(context).size.height * .62,
        //left: MediaQuery.of(context).size.width * 0.4,
        ...
        child: Column(
          children: [ Padding(
            ...
            child: Align(alignment: Alignment.centerLeft,child: Text("Welcome to,",
...
Positioned(bottom: MediaQuery.of(context).size.height * .25,
          left: MediaQuery.of(context).size.width * 0.1,
            ...
            Row(
              children: const [
                Padding(
                  ...
                  child: Align(
                    alignment: AlignmentDirectional.center,child: Text("Feel the sound with us!",
                      style: TextStyle(fontSize: 20
                      )),
                  ),
                ),
...
print("pressed");
 ...
 //                       tapTargetSize: MaterialTapTargetSize.shrinkWrap,
                    ...
                    child: const Padding(
                      padding: EdgeInsets.only(top: 7.0,bottom: 7.0,left: 80.0,right: 80.0),
